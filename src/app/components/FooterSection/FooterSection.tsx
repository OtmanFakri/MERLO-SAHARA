    ...
    return (
        <footer className="flex flex-col w-full bg-pro-themecomcod-gray">
                            ...
                            <Card className="bg-[#222222] rounded p-[50px] max-w-[390px]">
                                <CardContent className="p-0 space-y-[18.9px]">
                                    ...
                                    <div className="flex items-center">
                                        <div
                                            className="w-[205px] h-[62px] bg-[url(/image-1.png)] bg-cover bg-[50%_50%]"/>
                                    </div>
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col">
                                            <div className="pb-[15px]">
                                                <div
                                                    className="font-pro-theme-com-semantic-item-underline-upper text-pro-themecomcorn underline">
                                                    {item.date}
                                                </div>
                                            </div>
                                            <a
            ...
            <div className="border-t border-[#ffffff4c] py-[45px]">
                <div
                    className="container max-w-[1480px] px-10 flex flex-col md:flex-row justify-center items-center gap-4">
