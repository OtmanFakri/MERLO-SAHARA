...
export const EquipmentListingSection = (): JSX.Element => {
  ...
  const equipmentCards = [
    ...
    {
      id: 3,
      title: "Mini Excavator upto 5T",
      image: "/mini-excavator-upto-5t.png",
      brand: "Wacker Neuson",
      model: "EZ17",
      mfgYear: "2019",
      operatingWeight: "1.7 Ton",
    ...
    {
      id: 4,
      title: "Long Range Excavator 20T",
      image: "/long-range-excavator-20t.png",
      brand: "Wacker Neuson",
      model: "EZ17",
      mfgYear: "2019",
      operatingWeight: "1.7 Ton",
  ...
  return (
    <section className="flex flex-col items-start relative flex-1 self-stretch w-full">
      {/* Hero Banner */}
      <div className="flex h-[300px] items-center justify-center p-[15px] relative self-stretch w-full bg-[url(..//background.png)] bg-cover bg-center">
        ...
        <div className="flex flex-col max-w-[1480px] w-full items-start py-[70px]">
          <div className="flex flex-wrap items-start gap-0 relative self-stretch w-full">
            ...
            <div className="flex flex-col w-full md:w-1/3 lg:w-1/4 items-start justify-center pl-10">
              <div className="flex flex-col items-start gap-[60px] pr-10 relative flex-1 self-stretch w-full">
                <div className="bg-pro-themecomalabaster w-full">
                  ...
                  <div className="flex flex-col items-start gap-[22px] relative self-stretch w-full">
                    ...
                    <div className="flex flex-col items-start gap-[9px] relative self-stretch w-full">
                      ...
                      <div className="flex flex-col items-start gap-[5px] relative self-stretch w-full">
                        <label className="font-pro-theme-com-semantic-label text-pro-themecomgray text-[length:var(--pro-theme-com-semantic-label-font-size)] tracking-[var(--pro-theme-com-semantic-label-letter-spacing)] leading-[var(--pro-theme-com-semantic-label-line-height)]">
                          Select Category
                        </label>
                        <div className="relative self-stretch w-full h-[38px] border-b border-[#eeeeee]">
                          <Select>
                            <SelectTrigger className="border-none shadow-none h-[38px] font-medium text-[#222222] text-lg">
                      ...
                      {/* Pickup Location */}
                      <div className="flex flex-col items-start gap-[7px] relative self-stretch w-full">
                        <label className="font-pro-theme-com-semantic-label text-pro-themecomgray text-[length:var(--pro-theme-com-semantic-label-font-size)] tracking-[var(--pro-theme-com-semantic-label-letter-spacing)] leading-[var(--pro-theme-com-semantic-label-line-height)]">
                          Pickup Location
                        </label>
                        <div className="flex items-center w-full relative border-b border-[#eeeeee]">
                          <Input
                  ...
                  <div className="flex flex-col items-start gap-[17px] relative self-stretch w-full mt-[60px]">
                    ...
                    <div className="flex flex-col items-start relative self-stretch w-full">
                      {subcategories.map((category, index) => (
                        ...
                        >
                          ...
                          />
                          <span className="font-normal text-[#222222] text-lg leading-9 font-['Barlow',Helvetica]">
                            {category}
                          </span>
                        </a>
                      ))}
                  ...
                  <div className="flex flex-col items-start relative self-stretch w-full mt-[60px]">
                    <div className="flex items-center relative self-stretch w-full">
                      <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-sm font-light text-[#222222] leading-[19.6px] ml-1">
                          (Per Day)
                        </span>
                      </div>
                    </div>

                    <div className="flex flex-col items-center gap-[25px] relative self-stretch w-full mt-4">
                      <div className="relative w-full h-10 pt-9">
                        <div className="relative self-stretch w-full h-1 bg-pro-themecomalto rounded" />
                        <div className="absolute w-[169px] h-1 top-9 left-[76px] bg-pro-themecommid-gray" />
                  ...
                  <div className="flex flex-col items-start relative self-stretch w-full mt-[60px]">
                    ...
                    <div className="flex flex-col items-center gap-[25px] relative self-stretch w-full mt-4">
                      <div className="relative w-full h-10 pt-9">
                        <div className="relative self-stretch w-full h-1 bg-pro-themecomalto rounded" />
                        <div className="absolute w-[177px] h-1 top-9 left-[22px] bg-pro-themecommid-gray" />
                  ...
                  <div className="flex flex-col items-start relative self-stretch w-full mt-[60px]">
                    ...
                    <div className="flex flex-col items-center gap-[25px] relative self-stretch w-full mt-4">
                      <div className="relative w-full h-10 pt-9">
                        <div className="relative self-stretch w-full h-1 bg-pro-themecomalto rounded" />
                        <div className="absolute w-[244px] h-1 top-9 left-[67px] bg-pro-themecommid-gray" />
            ...
            <div className="flex flex-col w-full md:w-2/3 lg:w-3/4 items-end gap-[60px] pl-10">
              {/* Results Header */}
              <div className="flex items-center justify-between w-full bg-pro-themecomalabaster px-[30px]">
                <div>
                ...
                <div className="flex items-center">
                  <div className="flex items-center">
                    ...
                    <div className="relative px-[15px] mr-[30px]">
                      <Select>
                        <SelectTrigger className="border-none shadow-none font-medium text-[#222222] text-lg">
                ...
                {equipmentCards.map((card, index) => (
                  ...
                  >
                    ...
                    <CardContent className="p-[30px]">
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-6">
                        <div className="flex items-start">
                          <Badge className="w-1.5 h-1.5 rounded-[3px] p-0 mr-1.5 mt-1.5 bg-pro-themecomcorn" />
                          <span className="font-pro-theme-com-semantic-item text-[#222222] text-[length:var(--pro-theme-com-semantic-item-font-size)] leading-[var(--pro-theme-com-semantic-item-line-height)]">
                            Brand: {card.brand}
                          </span>
                        </div>
                        <div className="flex items-start">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-end">
                          ...
                          <span className="font-pro-theme-com-semantic-item-strikethrough text-pro-themecommine-shaft text-[length:var(--pro-theme-com-semantic-item-strikethrough-font-size)] leading-[var(--pro-theme-com-semantic-item-strikethrough-line-height)] line-through ml-1">
                            {card.originalPrice}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between mt-6">
                        <div className="flex items-center pl-[25px] bg-[url(..//item-11.png)] bg-cover bg-center">
                    ...
                    <CardFooter className="p-0">
                      <Button className="w-full h-[55px] rounded-sm border border-solid border-[#222222] bg-transparent text-[#222222] hover:bg-[#222222] hover:text-white">
                        <span className="font-pro-theme-com-barlow-bold-upper text-[length:var(--pro-theme-com-barlow-bold-upper-font-size)] leading-[var(--pro-theme-com-barlow-bold-upper-line-height)]">
                          BOOK NOW
                        </span>
              ...
              <div className="flex items-center justify-center mt-2.5 w-full">
                <Button className="w-[55px] h-[55px] bg-[#222222] rounded-sm border border-solid border-[#eeeeee]">
                  <span className="font-pro-theme-com-semantic-item-upper text-bananistyle text-[length:var(--pro-theme-com-semantic-item-upper-font-size)] leading-[var(--pro-theme-com-semantic-item-upper-line-height)]">
                    1
                  </span>
                </Button>
                <Button
