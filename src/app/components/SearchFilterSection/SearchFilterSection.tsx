            ...
            <div className="container py-[70px] px-10 max-w-[1680px]">
                <div className="flex flex-wrap justify-between items-center gap-8">
                    ...
                    <div className="flex-1 min-w-[300px]">
                        <div
                            className="flex flex-col md:flex-row items-start md:items-center gap-6 border-r border-white pr-[70px]">
                            ...
                            <div className="flex-1 w-full">
                                <Card
                                    className="bg-transparent border-[9px] border-solid border-[#ffffff33] rounded-sm p-[9px]">
